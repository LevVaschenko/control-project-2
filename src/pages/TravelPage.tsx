            ...
            <Container maxWidth="lg" className="lifestyle-page-container">
                <div className="main-content">
                    <div className="col-8">
                        ...
                        <div className="lifestyle-quantity">9 posts</div>
                        <div className="col-12 content">
                            <header className="entry-header">
                                ...
                                <div className="post-media">
                                    <img
                                        src="images/most-recent-image-12.jpeg"
                                        alt=""
                                        className="travel-page-image main-page-image"
                                    />
                                </div>
                            </header>
                        </div>
                                ...
                                <div className="post-inner123">
                                    <header className="entry-header1">
                                        ...
                                        <div className="post-title-pages lifestyle-page-article-title">
                                            Tips for Creating Awesome Double
                                            Exposures In-Camera
                                        </div>
                                    </header>
                                </div>
                            ...
                            <div className="lifestyle-page-post">
                                ...
                                <div className="post-inner123">
                                    <header className="entry-header1">
                                        ...
                                        <div className="post-title-pages lifestyle-page-article-title">
                                            Photography Lighting Lesson – How
                                ...
                                <div className="image kzjkcvzxv">
                                    <h3 className="lifestyle-info-4 kzjkcvzxv zxcjvn">
                                        ...
                                        <h4 className="entry-title-image zjcvzs lifestyle-page-article-title">
                                            Recommended Filters to Use With
                                            Black and White Photography
                                        </h4>
                                    </h3>
                                    <img
                                        src="images/travel-page-3.jpeg"
                                        alt=""
                            ...
                            <div className="lifestyle-page-post">
                                ...
                                <div className="post-inner123">
                                    <header className="entry-header1">
                                        ...
                                        <div className="post-title-pages lifestyle-page-article-title">
                                            12 Tips to Help You Improve Your
                            ...
                            <div className="lifestyle-page-post">
                                ...
                                <div className="post-inner123">
                                    <header className="entry-header1">
                                        ...
                                        <div className="post-title-pages lifestyle-page-article-title">
                                            11 Travel Photography Tips When
